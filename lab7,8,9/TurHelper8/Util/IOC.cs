...
namespace TurHelper.Util
{
    public class IOC
    {
        ...
        private void PSQL()
        {
            ...
            ninjectKernel.Bind<CityRepositoryInterface>().To<CityRepositoryPSQL>();
        }
        ...
        private void MSSQL()
        {
            ...
            ninjectKernel.Bind<CityRepositoryInterface>().To<CityRepositoryMSSQL>();
        }
        private void PSQLConString(string Login, string Password)
        {
            ...
            ninjectKernel.Bind<CityRepositoryInterface>().To<CityRepositoryPSQL>().WithConstructorArgument(ConString, 1);
        }
        private void MSSQLConString(string Login, string Password)
        {
            ...
            ninjectKernel.Bind<CityRepositoryInterface>().To<CityRepositoryMSSQL>().WithConstructorArgument(ConString, 1);
        }
    }
